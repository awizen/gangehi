...
public class MyLazyTasksModel extends LazyDataModel<WorkflowSummaryDto> {

	private ScheduleService scheduleService;
	private String userName;

	public MyLazyTasksModel(ScheduleService scheduleService, String userName) {
	...
	public List<WorkflowSummaryDto> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, Object> filters) {
		List<WorkflowSummaryDto> tasks = scheduleService.getTasks(first, pageSize, userName);
